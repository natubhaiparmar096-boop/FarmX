...
public class WorldChangeFailsafe extends Failsafe {
    ...
    public void onChatDetection(ClientChatReceivedEvent event) {
        ...
        if (message.startsWith("You cannot join SkyBlock from here!")) {
            ...
            LogUtils.sendWarning("[Failsafe Debug] FakePixel: skipped /lobby (command not available).");
    ...
    public void duringFailsafeTrigger() {
        ...
        switch (worldChangeState) {
            ...
            case TAKE_ACTION:
                ...
                // FakePixel: never send /skyblock, /lobby, or /warp garden
                if (GameStateHandler.getInstance().inGarden()) {
                    ...
                    LogUtils.sendWarning("[Failsafe Debug] FakePixel: skipped Hypixel warp commands.");
                    FailsafeManager.getInstance().stopFailsafes();
                    MacroHandler.getInstance().resumeMacro();
                }
                break;
